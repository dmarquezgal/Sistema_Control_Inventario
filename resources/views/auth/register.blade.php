...
rounded-lg shadow-lg">
    ...
    <form class="mt-4" method="POST" action="">
        ...
        placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="E-mail" id="email" name="email">
        ...
        <input type="password" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg 
        placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Confirm password" id="password_confirmation" 
        name="password_confirmation">

        <button type="submit" class="rounded-md bg-indigo-500 w-full text-lg text-white font-semibold
        p-2 my-3 hover:bg-indigo-600 focus:bg-indigo-600">
            Send
        </button>
    </form>
